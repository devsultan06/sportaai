...
const sportsOptions = [
    ...
    { id: 2, name: "Football", description: "The Beautiful Game: Where passion meets artistry on the pitch", logo: "/images/football.png" },
    { id: 3, name: "Basketball", description: "Every Shot Counts: Precision, teamwork, and electrifying moments", logo: "/images/basketball.png" },
    { id: 4, name: "American Football", description: "Battle on the Gridiron: Power, strategy, and adrenaline", logo: "/images/baseball.png" },
    { id: 5, name: "Volley Ball", description: "Every Shot Counts: Precision, teamwork, and electrifying moments", logo: "/images/basketball.png" },
    ...
    return (
        <div className="flex flex-col gap-4 mt-[20px] relative opacity-70 pb-[50px]">
            {filteredSports.length > 0 ? (
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div className="text-left sport">
                                <h2 className="text-lg font-bold text-[#EAEAEA]">{sport.name}</h2>
                ...
                ${selectedSport === sport.id ? "border-white" : "border-gray-500"}`}
                        >
