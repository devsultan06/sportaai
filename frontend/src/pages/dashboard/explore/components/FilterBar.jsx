...
const FilterBar = ({
  ...
  return (
    <div className="flex items-center justify-between bg-[#121212] rounded-xl text-white">
      ...
      <div className="flex items-center justify-center gap-[21px] bg-[#2A2A2A] w-[300px] px-4 py-[14px] rounded-[24px]">
