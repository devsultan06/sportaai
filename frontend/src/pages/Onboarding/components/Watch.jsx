...
const Watch = ({ swiperRef }) => {
    ...
    return (
        ...
        <div
            ...
            className="flex max-860:flex-col max-860:gap-[30px] max-860:justify-center max-860:mx-auto justify-center items-center gap-[40px] w-full p-8 h-screen max-1075:h-fit"
        >
            ...
            <div className="text-white text-center bg-opacity-50 rounded-lg">
                ...
                <div className="slide mb-[30px]">
                    ...
                    <button onClick={() => swiperRef && swiperRef.slideTo(1)} className="active"></button>
