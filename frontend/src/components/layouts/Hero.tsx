            ...
            <div className="flex justify-center mt-6 items-center gap-3 font-metropolisBold">
                <div className="w-[200px]">
                    <button
                        ...
                        className="flex create w-full justify-center items-center gap-2 h-[50px] px-3 text-[#1A1A1A] text-[13px] font-bold rounded-[1000px] hover:opacity-90 transition-all"
                    >
                        Get the App Now
                ...
                <div className="w-[200px]">
                    <button
                        ...
                        className="flex second create w-full justify-center items-center gap-2 h-[50px] px-3  text-[13px] font-bold rounded-[1000px] hover:opacity-90 transition-all"
                    >
                        Explore on Desktop
